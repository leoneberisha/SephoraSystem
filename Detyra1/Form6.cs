...
namespace Detyra1
{
    public partial class Form6 : Form
    {
        ...
        public void LoadFondatine()
        {
            ...
            {
                string query = @"SELECT id, emri_kategoris AS 'Kategoria', emri_furnitorit AS 'Furnitori',
        ...
        private void button4_Click(object sender, EventArgs e) //edit
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                string emri_kategoris = selectedRow.Cells["Emri Kategorise"].Value.ToString();
                string emri_furnitorit = selectedRow.Cells["Emri Furnitorit"].Value.ToString();
                ...
                Form5 form5 = new Form5(this, id, emri_kategoris, emri_furnitorit, emri_fondatines,
                    nuanca, stoku, sasia, cmimiBlerjes, cmimiShitjes, totali, aktiv, true); // true = editing mode
                form5.ShowDialog();
            }
            else
            {
